            ...
            >
              ...
              <div className="flex justify-between text-sm mb-3">
                ...
                <div className="text-right">
                  ...
                  <p className="font-bold text-blue-700">₹{l.emi.toLocaleString('en-IN')}</p>
                </div>
              </div>
              <div className="mb-2">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        ...
        <div className="grid grid-cols-3 gap-4 bg-blue-50 rounded-xl p-4">
          <div className="text-center">
            ...
            <p className="text-2xl font-bold text-blue-900">₹{emi.toLocaleString('en-IN')}</p>
          </div>
          <div className="text-center">
            <p className="text-xs text-blue-600 mb-1">Total Interest</p>
            <p className="text-2xl font-bold text-blue-900">₹{interest.toLocaleString('en-IN')}</p>
          </div>
          <div className="text-center">
            <p className="text-xs text-blue-600 mb-1">Total Amount</p>
            <p className="text-2xl font-bold text-blue-900">₹{total.toLocaleString('en-IN')}</p>
          </div>
        </div>
      </div>
    </div>
