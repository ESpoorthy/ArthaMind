        ...
        {notifs.map((n) => {
          ...
          return (
            <div
              ...
              className={`bg-white rounded-xl p-4 shadow-sm border cursor-pointer transition hover:shadow-md ${n.read ? 'border-gray-100 opacity-70' : 'border-blue-200'}`}
            >
              <div className="flex items-start gap-3">
                <div
                  className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 ${col}`}
                >
